...
dataset_aliases = {"ADULT": "Census income",  "ATUS": "Time use", "IHIS": "Health interviews", "SS13ACS": "Census community", "CREDITCARD": "Credit card",
...
y_ticks_for_ex1 = {"Distinguishability": {"ADULT": [0.4, 5], "ATUS": [4, 5], "IHIS": [50, 6]},
                   "Population Uniqueness": {"ADULT": [1.5, 4],  "ATUS": [12, 5], "IHIS": [60, 5]}}
...
def load_and_calc_avg(file_name, descriptive_column_names):
    ...
    for permutation in all_permutations:
        ...
        result_line['time_gmean'] = gmean(df_temp['time'])
        result_line['utility_gmean'] = gmean(df_temp['externalUtility'])
...
def load_and_create_traces(file_name, descriptive_column_names, end_point=0, utility_column='externalUtility'):
    df_all = pd.read_csv(file_name, sep=";", skiprows=0)
    ...
    for permutation in all_permutations:
        ...
        utility_trace = df_temp[utility_column].tolist()

        if utility_column == "internalUtility":
            utility_trace = [1-y for y in utility_trace]

        result_line['utility_trace'] = utility_trace
...
draw_experiment1("results_revision\\Experiment1_kAnon_pop50.csv", "figures_revision\\ex1_kAnon.svg", "Distinguishability", costum_dataset_order=costum_dataset_order_ld, costum_algorithm_order=costum_algorithm_order_ld)
draw_experiment1("results_revision\\Experiment1_popUnique_pop50.csv", "figures_revision\\\\ex1_PopUnique.svg", "Population Uniqueness", costum_dataset_order=costum_dataset_order_ld, costum_algorithm_order=costum_algorithm_order_ld)
...
draw_experiment2("results_revision\\Experiment2_kAnon_pop50.csv", "figures_revision\\ex2_kAnon.svg", figure_title="Distinguishability", costum_algorithm_order=costum_algorithm_order_hd, costum_dataset_order=costum_dataset_order_hd)
draw_experiment2("results_revision\\Experiment2_popUnique_pop50.csv", "figures_revision\\ex2_popUnique.svg", figure_title="Population Uniqueness",costum_algorithm_order=costum_algorithm_order_hd, costum_dataset_order=costum_dataset_order_hd)
...
draw_experiment3("results_revision\\Experiment3_kAnon_pop50.csv", "figures_revision\\ex3_kAnon.svg", "Distinguishability", costum_dataset_order=costum_dataset_order_hd, costum_algorithm_order = costum_algorithm_order_hd)
draw_experiment3("results_revision\\Experiment3_PopUnique_pop50.csv",  "figures_revision\\ex3_PopUnique.svg", "Population Uniqueness", costum_dataset_order=costum_dataset_order_hd, costum_algorithm_order = costum_algorithm_order_hd)
