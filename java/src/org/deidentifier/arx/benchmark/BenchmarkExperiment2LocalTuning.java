 ...
 */
public class BenchmarkExperiment2LocalTuning extends AbstractBenchmark {
    ...
    enum TuningParameter {
                          ...
                          IMMIGRATION_FRACTION("immigrationFraction",
                                               new Double[] { 0.4, 0.6, 0.8 }),
     ...
     * @param fileName
     */
    BenchmarkExperiment2LocalTuning(String fileName) {
    ...
    public static void main(String args[]) throws IOException {
        new BenchmarkExperiment2LocalTuning("results/ParameterTuning/Experiment3_kAnon.csv").start();
    }
                ...
                for (int timeLimit : timeLimits) {
                    for (TuningParameter parameter : tuningParameters) {
                        for (Number value : parameter.tuningValues) {
                            ...
                            // GA settings - change tuned parameter to value
                            switch (parameter) {
                            case ELITE_FRACTION:
